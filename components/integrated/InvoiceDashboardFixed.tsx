...
export function InvoiceDashboardFixed() {
  ...
  if (!connected) {
    return (
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#0F0F23] via-[#1a1a3e] to-[#0F0F23]">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
          ...
          >
            <Card className="glass p-8 text-center max-w-md border border-white/10">
        ...
        <div className="max-w-7xl mx-auto">
              ...
              return (
                ...
                >
                  <Badge
                    ...
                    className={`cursor-pointer px-6 py-3 text-sm transition-all duration-300 backdrop-blur-md ${
                      isActive
          ...
          {showCreateInvoice ? (
            ...
            <div className="space-y-6">
              ...
              >
                <Card className="glass p-6 border-l-4 border-purple-500 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 shadow-lg shadow-purple-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  return (
                    ...
                    >
                      <Card className="glass p-6 h-full border border-white/10 hover:border-purple-500/30 transition-all duration-300 shadow-lg">
              ...
              >
                <Card className="glass p-6 border border-white/10 shadow-lg">
                    ...
                    {[
                      ...
                      return (
                        <motion.button
                          ...
                          whileHover={{ scale: 1.05, y: -5 }}
                          whileTap={{ scale: 0.95 }}
                          className="glass p-6 rounded-lg text-left group transition-all duration-300 border border-white/10 hover:border-purple-500/30"
                        >
              ...
              >
                <Card className="glass p-6 border border-white/10 shadow-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <motion.div 
                      className="glass p-6 rounded-lg border border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-purple-500/5"
                    ...
                    <motion.div 
                      className="glass p-6 rounded-lg border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 to-cyan-500/5"
                      whileHover={{ scale: 1.02 }}
                    >
              ...
              >
                <Card className="glass p-6 border-l-4 border-cyan-500 border border-cyan-500/30 shadow-lg shadow-cyan-500/20">
                  <div className="flex items-start gap-4">
